...
namespace Mentor_Management_System.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<Mentor_Management_SystemUser> signInManager, ILogger<LoginModel> logger, UserManager<Mentor_Management_SystemUser> userManager, RoleManager<IdentityRole> roleManager)
        {
